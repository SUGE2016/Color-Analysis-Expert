...
| RPT-02 | 单图报告 | `GET /api/reports/projects/{projectId}/images/{imageName}` | 200（imageName 取自数据集实际上传文件名） | SKIP |
| RPT-03 | 导出 CSV | `GET /api/reports/projects/{projectId}/export?format=csv` | 200，可下载文件流 | SKIP |
